...
``` {r read_data}
blog_entries<-readLines("C:/Users/TOSHIBA/Documents/Coursera/10 Data Science Capstone/Capstone-master/Milestone Report/en_US.blogs.txt", skipNul = TRUE, warn= FALSE)
news_entries<-readLines("C:/Users/TOSHIBA/Documents/Coursera/10 Data Science Capstone/Capstone-master/Milestone Report/en_US.news.txt", skipNul = TRUE, warn=FALSE)
twitter_feeds<-readLines("C:/Users/TOSHIBA/Documents/Coursera/10 Data Science Capstone/Capstone-master/Milestone Report/en_US.twitter.txt", skipNul = TRUE, warn=FALSE)
```

#### Calculate the **SIZE** of the English dataset (in megabytes) and display
``` {r file_size}
blog_entries_size<-file.info("C:/Users/TOSHIBA/Documents/Coursera/10 Data Science Capstone/Capstone-master/Milestone Report/en_US.blogs.txt")$size/ 1024 ^ 2
news_entries_size<-file.info("C:/Users/TOSHIBA/Documents/Coursera/10 Data Science Capstone/Capstone-master/Milestone Report/en_US.news.txt")$size/ 1024 ^ 2
twitter_feeds_size<-file.info("C:/Users/TOSHIBA/Documents/Coursera/10 Data Science Capstone/Capstone-master/Milestone Report/en_US.twitter.txt")$size/ 1024 ^ 2
```
